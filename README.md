...
2. Inside the project's root directory, download and install ns-3 (ns-3.42: ns-3-dev and 5g-lena v3.3.y)
...
4. Get the datasets from the following link:
    ...
    - Place them in "ds-15" subdirectory inside "split" folder.
